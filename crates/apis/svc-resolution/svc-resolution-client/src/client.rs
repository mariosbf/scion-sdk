...
//!
//! # async fn example(socket: scion_stack::UdpScionSocket) -> Result<(), Box<dyn std::error::Error>> {
//! let client = UdpScionServiceResolutionClient::new(socket, Some(Duration::from_secs(5)));
//!
//! let dst = ScionSocketAddrSvc::new(
//!     IsdAsn::from_str("1-ff00:0:110")?,
//!     ServiceAddr::CONTROL,
//!     0,
//! );
...
use scion_stack::UdpScionSocket;
use sciparse::address::socket_addr::ScionSocketAddrSvc;
